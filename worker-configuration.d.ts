/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9495867df30beddb968a79b2c5f9fa6a)
// Runtime types generated with workerd@1.20260611.1 2026-06-15 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	EMAIL: SendEmail;
	BROWSER: BrowserRun;
	DEFAULT_EMAIL_TO: "shironeko1052@gmail.com";
	EMAIL_FROM: "notifications@mail.mskf.work";
	MONITOR_URL: "https://anc.apm.activecommunities.com/seattle/activity/search?onlineSiteId=0&site_ids=3&activity_keyword=18%2B%201.0&viewMode=list";
	MONITOR_NAME: "Seattle ActiveCommunities courses";
	INTERVAL_SECONDS: "80";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEFAULT_EMAIL_TO" | "EMAIL_FROM" | "MONITOR_URL" | "MONITOR_NAME" | "INTERVAL_SECONDS">> {}
}
